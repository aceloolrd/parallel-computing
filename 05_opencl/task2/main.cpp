...
int main()
{
    for (int i = 0; i < 10; ++i) {
        ...
        cl_mem d_A = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, byte_size, Am,
            NULL);

        cl_mem d_B = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, byte_size, Bm,
            NULL);
        ...
        const char* kernelSource =
            "__kernel void matrixMult(__global const short* Am, __global const short* Bm, __global short* result, int size) {\n"
